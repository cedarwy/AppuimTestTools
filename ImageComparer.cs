...
namespace AppuimTestTools
{
    ...
    public class ImageComparer
    {
        ...
        public static List<Rectangle> Compare(Bitmap bmp1, Bitmap bmp2, Size block)
        {
            ...
            BitmapData bd1 = bmp1.LockBits(new Rectangle(0, cut, bmp1.Width, bmp1.Height- cut), ImageLockMode.ReadOnly, pf);
            BitmapData bd2 = bmp2.LockBits(new Rectangle(0, cut, bmp2.Width, bmp2.Height- cut), ImageLockMode.ReadOnly, pf);
                            ...
                            for (int i = 0; i < block.Width; i++)
                            {
                                ...
                                for (int j = 0; j < block.Height; j++)
                                {
                                    ...
                                    if (pc1->R != pc2->R || pc1->G != pc2->G || pc1->B != pc2->B)
                                    {
                                        ...
                                        rects.Add(new Rectangle(w, h+cut, bw, bh));
